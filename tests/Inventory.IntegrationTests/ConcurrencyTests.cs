...
public class ConcurrencyTests : IClassFixture<CustomWebApplicationFactory_NoBackground>
{
    private readonly HttpClient _client;
    private readonly CustomWebApplicationFactory_NoBackground _factory;
    public ConcurrencyTests(CustomWebApplicationFactory_NoBackground factory)
    {
        _factory = factory;
